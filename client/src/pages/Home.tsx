    ...
    <div className="site-shell">
      ...
      <main className="content-column" id="top">
        <section className="hero-section" id="about">
          ...
          <div className="hero-grid"><div><h2>Researching <em>transparent</em> intelligent systems for legal reasoning.</h2><p className="hero-lede">I am Pengjie Liu, a researcher working at the intersection of legal artificial intelligence, information retrieval and knowledge graphs. My work studies how structured evidence, retrieval and representation learning can make intelligent systems easier to understand and use.<br /><strong>Doctoral supervision:</strong> Primary supervisor: <a href="https://www.cae.cn/cae/html/main/colys/71311121.html" target="_blank" rel="noreferrer">Prof. Xiaohua Gan, CAE Academician</a>; co-supervisor: <a href="https://risks-x.sustech.edu.cn/faculty/detail/id/65.html?lang=zh-cn" target="_blank" rel="noreferrer">Prof. Shuang-Hua Yang, CAE Academician</a>.</p><div className="hero-actions"><a className="ink-button" href="#publications">Selected publications <ArrowUpRight size={16} /></a><Link href={scholarUrl}>Google Scholar</Link></div></div><aside className="hero-aside"><div className="aside-line"><span>Research</span><strong>Legal AI<br />Information retrieval<br />Knowledge graphs</strong></div><div className="aside-line"><span>Based in</span><strong>Shenzhen, China<br />Southern University of Science and Technology</strong></div></aside></div>
        </section>
