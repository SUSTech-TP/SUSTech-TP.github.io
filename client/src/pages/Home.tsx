...
const news = [
  ...
  ["2024.12", "MUSE: Integrating Multi-Knowledge for Knowledge Graph Completion was published in the ADMA 2024 proceedings."],
...
const publications = [
  ["Neurocomputing · 2025 · JCR Q1 · Impact factor 6.5", "SEMKR: Joint Learning of Semantic and Topological Representations for Knowledge Graph Completion", "Pengjie Liu, Wang Zhang, Yulong Ding, Jie Jiang, Shuang-Hua Yang", "https://www.sciencedirect.com/science/article/abs/pii/S0925231225015814"],
  ["IEEE SMC · 2024 · Long paper · CCF-C", "SEMDR: A Semantic-Aware Dual Encoder Model for Legal Judgment Prediction with Legal Clue Tracing", "Pengjie Liu, Wang Zhang, Yulong Ding, Xuefeng Zhang, Shuang-Hua Yang", "https://ieeexplore.ieee.org/document/10830950"],
  ["DASFAA · 2025 · Long oral presentation · CCF-B", "JurisNexus: Enhancing Legal Judgment Prediction via Cross-Reasoning-Chain Representation Learning Mechanism", "Pengjie Liu, Xiaoqing Zhang, Yulong Ding, Shuang-Hua Yang", "https://link.springer.com/chapter/10.1007/978-981-95-3827-0_5"],
  ["ADMA · 2024 · Long paper · CCF-C", "MUSE: Integrating Multi-Knowledge for Knowledge Graph Completion", "Pengjie Liu", "https://link.springer.com/chapter/10.1007/978-981-96-0814-0_26"],
  ["ICMLC & ICWAPR · 2024 · Finalist, Lotfi Zadeh Best Paper Awards", "MUSE: Multi-knowledge Passing on the Edges, Boosting Knowledge Graph Completion", "Pengjie Liu", "https://ieeexplore.ieee.org/document/10935121"],
  ["ICIC · 2025 · Long paper · CCF-C", "ECHO: Enhancing Knowledge Graph Completion via Multi-source Knowledge Representation Learning Mechanism with Continual Pre-training", "Pengjie Liu, Wang Zhang, Yulong Ding, Shuang-Hua Yang", "https://dl.acm.org/doi/10.1007/978-981-96-9881-3_43"],
];
    ...
    <div className="site-shell">
      ...
      <main className="content-column" id="top">
        <section className="hero-section" id="about">
          ...
          <div className="hero-grid"><div><h2>Researching <em>transparent</em> intelligent systems for legal reasoning.</h2><p className="hero-lede">I am Pengjie Liu, a researcher working at the intersection of legal artificial intelligence, information retrieval and knowledge graphs. My work studies how structured evidence, retrieval and representation learning can make intelligent systems easier to understand and use. My doctoral research is supervised by <a href="https://www.cae.cn/cae/html/main/colys/71311121.html" target="_blank" rel="noreferrer">Prof. Xiaohua Gan, CAE Academician</a>, with <a href="https://risks-x.sustech.edu.cn/faculty/detail/id/65.html?lang=zh-cn" target="_blank" rel="noreferrer">Prof. Shuang-Hua Yang, CAE Academician</a> serving as co-supervisor.</p><div className="hero-actions"><a className="ink-button" href="#publications">Selected publications <ArrowUpRight size={16} /></a><Link href={scholarUrl}>Google Scholar</Link></div></div><aside className="hero-aside"><div className="aside-line"><span>Research</span><strong>Legal AI<br />Information retrieval<br />Knowledge graphs</strong></div><div className="aside-line"><span>Based in</span><strong>Shenzhen, China<br />Southern University of Science and Technology</strong></div></aside></div>
        </section>
        ...
        <section className="section-block" id="experience"><div className="section-heading"><span className="section-index">03</span><h3>Internship experience</h3></div><div className="timeline-list"><div className="timeline-item"><time>2023.10 — 2024.03</time><div><h4>Alibaba</h4><p>Algorithm Intern · Zhejiang · Hangzhou</p></div></div><div className="timeline-item"><time>2019.03 — 2019.09</time><div><h4>Loughborough University</h4><p>Research Assistant · UK · Loughborough</p></div></div></div></section>

        <section className="section-block" id="research"><div className="section-heading"><span className="section-index">04</span><h3>Research</h3></div><div className="research-lead"><p>My research asks how a system can <strong>retrieve the right evidence, represent it clearly and explain the path from question to decision.</strong></p><div className="research-signals"><span>01 / Representation</span><span>02 / Retrieval</span><span>03 / Reasoning</span></div></div><div className="interest-grid"><div className="interest"><Network size={19} /><div><h4>Knowledge graphs</h4><p>Semantic and topological representations for structured completion and evidence linking.</p></div></div><div className="interest"><Search size={19} /><div><h4>Information retrieval</h4><p>Finding the right clue, source or precedent before a model starts to explain.</p></div></div><div className="interest"><BookOpen size={19} /><div><h4>Legal reasoning</h4><p>Representation learning and reasoning chains for legal judgment prediction.</p></div></div></div></section>

        <section className="section-block" id="projects"><div className="section-heading"><span className="section-index">05</span><h3>Selected projects</h3><Link href={githubUrl}>All repositories</Link></div><div className="project-grid">{projects.map(([title, type, description, href], index) => <a className="project-card" href={href} target="_blank" rel="noreferrer" key={title}><div className={`project-image project-image-${index + 1}`}><span>{String(index + 1).padStart(2, "0")}</span></div><div className="project-card-body"><p className="project-type">{type}</p><h4>{title}<ArrowUpRight size={15} /></h4><p>{description}</p><span className="project-open">View repository</span></div></a>)}</div></section>

        <section className="section-block" id="services"><div className="section-heading"><span className="section-index">06</span><h3>Academic services</h3></div><div className="service-grid"><div><BriefcaseBusiness size={19} /><h4>Conference service</h4><p>Program Committee Member for ICIC 2025, PRICAI 2025, PRICAI 2026 and ICAI 2025; Workshop Chair for IEEE BDDM 2025.</p></div><div><GraduationCap size={19} /><h4>Memberships</h4><p>CCF Student Member and IEEE Student Member.</p></div><div><BookOpen size={19} /><h4>Peer review</h4><p>Reviewer for CCF-indexed conferences including AAAI, EMNLP, NAACL, COLING, ICASSP, ICME, ICIC, ICANN, IJCNN, IEEE SMC and PRICAI, as well as SCI journals EAAI and Neurocomputing.</p></div></div></section>

        <section className="section-block publications-section" id="publications"><div className="section-heading"><span className="section-index">07</span><h3>Publications</h3><Link href={scholarUrl}>Full list on Scholar</Link></div><p className="publication-note">Selected work · please follow the linked scholarly record for the latest publication status.</p><div className="publication-list">{publications.map(([venue, title, authors, paperUrl], index) => <article className="publication-row" key={title}><div className="publication-number">{String(index + 1).padStart(2, "0")}</div><div className="publication-body"><p className="publication-venue">{venue}</p><h4>{title}</h4><p className="publication-authors"><Authors value={authors} /></p></div><Link href={paperUrl}>Paper</Link></article>)}</div></section>

        <section className="section-block contact-section" id="contact"><div className="section-heading"><span className="section-index">08</span><h3>Contact</h3></div><div className="contact-grid"><div><p className="contact-lead">For research collaboration, academic discussion or questions about the projects, please write by email.</p><a className="contact-email" href={email}>pengjieliu@sustech.edu.cn <ArrowUpRight size={16} /></a></div><div className="contact-links"><Link href={githubUrl}>GitHub repositories</Link><Link href={scholarUrl}>Google Scholar profile</Link></div></div></section>
